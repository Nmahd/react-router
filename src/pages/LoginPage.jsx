...
<>
   ...
   <h2 className='text-4xl'>Sign in with email</h2>
   <p>See the user details</p>
   ...
   <input type="password" placeholder='Enter password' className='bg-black h-10 w-80 p-5' />
    <button className=' bg-purple-700 hover:bg-white hover:text-black p-3 rounded-md m-2 focus:outline-2'>Login</button>
